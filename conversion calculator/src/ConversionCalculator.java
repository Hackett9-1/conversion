...
public class ConversionCalculator {
  ...
  public static void main(String[] args) {
    ...
    // a quick show of arrays inspired by
    // https://www.udemy.com/course/java-tutorial/learn/lecture/137076#overview
    ...
    System.out.println("Please follow the \'instructions\' carefully"); // put the escape sequence
    // here to show case
    // it
    ...
    System.out.println(
        val + fromUnit + " " + "= " + Math.round(converted * 100.0) / 100.0 + toUnit); // use
    // of
    // math
    // class
    // and
    ...
    System.out.println(
        "Here is a \"fun\" random number to try to conver next  " + random.nextInt(50000));
